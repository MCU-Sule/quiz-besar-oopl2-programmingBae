...
public class MainViewController implements Initializable {
    ...
    public void openBookManagement(ActionEvent actionEvent) throws IOException {
        ...
        ResourceBundle resources = ResourceBundle.getBundle("resourceBundle", locale2);
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../views/bookManagement.fxml"),resources);
